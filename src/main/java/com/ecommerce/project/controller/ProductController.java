...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getAllProducts(
            ...
            @RequestParam(name="sortBy", defaultValue = AppConstants.DEFAULT_PRODUCT_BY , required = false) String sortBy,
    ...
    {
        ProductDTO deleteProduct = productService.deleteProductById(productId);
